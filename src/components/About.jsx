...
const About = () => {
  return (
    <motion.section
      ...
      initial="hidden"
      animate="visible"
      className=" section fp-auto-height  h-full md:h-[120vh] min-h-full md:min-h-screen bg-top mt-[-20vh] z-100 bg-cover  bg-[url('../src/assets/bottom_2.svg')]  bg-no-repeat flex justify-center items-center relative">
