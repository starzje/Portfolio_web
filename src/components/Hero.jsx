...
const Hero = ({ fullpageApi }) => {
  ...
  return (
    <motion.main
      ...
      initial="hidden"
      animate="visible"
      className=" fp-bg m-0  fixed md:relative overflow-y-scroll mobile-fix  section h-[100%] bg-[#120C5C] bg-hero-pattern2  bg-cover bg-center bg-no-repeat top-[0.1px] bottom-0 left-0 right-0 ">
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="fixed  -right-0 mobile-fix   w-screen fullheight md:h-full overflow-y-scroll md:overflow-hidden bg-slate-900 bg-opacity-100 z-[100]  ">
