...
const Hero = ({ fullpageApi }) => {
  ...
  return (
    <motion.main
      ...
      initial="hidden"
      animate="visible"
      className=" fp-bg m-0  fixed md:relative overflow-y-scroll mobile-fix  section bg-[#120C5C] bg-hero-pattern2  bg-cover bg-center bg-no-repeat top-[0.1px] bottom-0 left-0 right-0 ">
